(function() {
  ...
  exports.ContractValue = ContractValue = (function(_super) {
    ...
    ContractValue.prototype.compileNode = function(o) {
      if (!(this.contract_var.base.value === this.value_var.base.value)) void 0;
      if (o.contracts) {
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.compileNode = function(o) {
      ...
      if (this.generated) {
        for (_i = 0, _len = props.length; _i < _len; _i++) {
          node = props[_i];
          if (node instanceof Value) void 0;
        }
      }
      idt = o.indent += TAB;
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (!this.context) {
        if (!(varBase = this.variable.unwrapAll()).isAssignable()) void 0;
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      for (i = 0, _len = objects.length; i < _len; i++) {
        ...
        if (!splat && obj instanceof Splat) {
          ...
          if (obj instanceof Splat) obj = obj.name.compile(o);
