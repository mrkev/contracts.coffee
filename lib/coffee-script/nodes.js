(function() {(function() {
  ...
  var Access, Arr, ArrayContract, Assign, Base, Block, CONTRACT_PREFIX, Call, Class, Closure, Code, Comment, ContractOp, ContractValue, Existence, Extends, For, FunctionContract, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, ObjectContract, Op, OptionalContract, Param, Parens, RESERVED, Range, RestContract, Return, SIMPLENUM, Scope, SelfContract, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, WrapContract, YES, compact, del, ends, extend, flatten, fs, last, makeObjectProp, merge, multident, path, starts, unfoldSoak, utility, _ref;
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, cpath, loadContracts, loadVirt, patchRequire, vpath;
      ...
      loadContracts = o.contracts && o.withLib ? fs.readFileSync(cpath, 'utf8') : '';
      vpath = path.join(path.dirname(fs.realpathSync(__filename)), 'loadVirt.js');
      loadVirt = o.virtualize ? fs.readFileSync(vpath, 'utf8') : '';
      patchRequire = "(function() {\n  var old_require = require;\n  require = function(mod, filename) {\n    var key, m = old_require(mod);\n    for(key in m) {\n      if(typeof(m[key]) && m[key].hasOwnProperty && m[key].hasOwnProperty('use')) {\n        m[key] = m[key].use(filename, mod);\n      }\n    }\n    return m;\n  };\n  for(var key in old_require) {\n    require[key] = old_require[key];\n  }\n})();";
      if (o.bare) return code;
      return "(function() {" + patchRequire + "\n" + loadVirt + "\n" + loadContracts + "\n" + code + "\n}).call(this);\n";
    };
  ...
  exports.OptionalContract = OptionalContract = (function() {

    __extends(OptionalContract, Base);
    ...
    OptionalContract.prototype.compileNode = function(o) {
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "opt(" + (this.value.compile(o)) + ")";
    };
  ...
  exports.ContractOp = ContractOp = (function() {

    __extends(ContractOp, Base);
    ...
    ContractOp.prototype.compileNode = function(o) {
      if (this.op === '||') {
        return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "or(" + (this.first.compile(o)) + ", " + (this.second.compile(o)) + ")";
      } else if (this.op === '&&') {
        return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "and(" + (this.first.compile(o)) + ", " + (this.second.compile(o)) + ")";
      } else {
  ...
  exports.SelfContract = SelfContract = (function() {

    __extends(SelfContract, Base);

    function SelfContract() {}

    SelfContract.prototype.compileNode = function(o) {
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "self";
    };
  ...
  exports.WrapContract = WrapContract = (function() {

    __extends(WrapContract, Base);
  ...
  exports.FunctionContract = FunctionContract = (function() {

    __extends(FunctionContract, Base);

    function FunctionContract(dom, rng, tags, opts, thisContract) {
      var tc;
      this.dom = dom;
      this.rng = rng;
      this.tags = tags;
    ...
    FunctionContract.prototype.compileNode = function(o) {
      var depargs, n, params, range;
      params = this.dom.compile(o);
      range = this.rng.compile(o);
      if (this.rng instanceof WrapContract) {
        depargs = ((function() {
          var _ref2, _results;
          _results = [];
          for (n = 1, _ref2 = this.dom.objects.length; 1 <= _ref2 ? n <= _ref2 : n >= _ref2; 1 <= _ref2 ? n++ : n--) {
            _results.push("$" + n);
          }
          return _results;
        }).call(this)).join(", ");
      ...
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "fun(" + params + ", " + range + ", " + (this.options.compile(o)) + ")";
    };
  ...
  exports.RestContract = RestContract = (function() {

    __extends(RestContract, Base);
    ...
    RestContract.prototype.compileNode = function(o) {
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "___(" + (this.contract.compile(o)) + ")";
    };
  ...
  exports.ObjectContract = ObjectContract = (function() {

    __extends(ObjectContract, Base);
    ...
    ObjectContract.prototype.compileNode = function(o) {
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "object(" + (this.oc.compile(o)) + ", " + (this.options.compile(o)) + ")";
    };
  ...
  exports.ArrayContract = ArrayContract = (function() {

    __extends(ArrayContract, Base);
    ...
    ArrayContract.prototype.compileNode = function(o) {
      return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "arr(" + (this.arc.compile(o)) + ")";
    };
  ...
  exports.ContractValue = ContractValue = (function() {

    __extends(ContractValue, Base);
    ...
    ContractValue.prototype.compileNode = function(o) {
      ...
      if (o.contracts) {
        return "" + (o.contractPrefix ? CONTRACT_PREFIX : '') + "guard(" + (this.contract.compile(o, LEVEL_PAREN)) + "," + (this.value.compile(o, LEVEL_PAREN)) + ")";
      } else {
        return "{ use: function() { return " + (this.value.compile(o, LEVEL_PAREN)) + "; } }";
      }
    };
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.compileNode = function(o) {
      ...
      } else if (o.contracts && ((_ref3 = this.variable) != null ? (_ref4 = _ref3.base) != null ? _ref4.value : void 0 : void 0) === 'require') {
        return (this.isNew ? 'new ' : '') + this.variable.compile(o, LEVEL_ACCESS) + ("(" + args + ", '" + o.filename + "')");
      } else {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileNode = function(o) {
      var cfirst, code, csecond, isChain;
      ...
      cfirst = this.first.compile(o, LEVEL_OP);
      csecond = this.second.compile(o, LEVEL_OP);
      if (o.virtualize) {
        code = "Proxy.dispatchBinary('" + this.operator + "', " + cfirst + ", " + csecond + ", function() { return " + cfirst + " " + this.operator + " " + csecond + ";})";
      } else {
        code = cfirst + ' ' + this.operator + ' ' + csecond;
      }
      if (o.level <= LEVEL_OP) {
        return code;
      } else {
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      if (o.virtualize) {
        return "Proxy.dispatchUnary('" + op + "', " + cfirst + ", function() { return " + (parts.join('')) + "; })";
      } else {
        return parts.join('');
      }
    };
  ...
  exports.If = If = (function() {
    ...
    If.prototype.compileStatement = function(o) {
      ...
      if (o.virtualize) cond = "Proxy.dispatchTest(" + cond + ")";
      o.indent += TAB;
