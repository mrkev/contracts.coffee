  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.literalToken = function() {
      ...
      if (value === ';') {
        ...
        tag = "CONTRACT_OPT";
      } else if (__indexOf.call(LOGIC, value) >= 0 || value === '?' && (prev != null ? prev.spaced : void 0) && !(prev[0] === '=')) {
        tag = 'LOGIC';
      } else if (prev && value === '[' && prev[0] === '::' && prev.spaced) {
        prev[0] = 'CONTRACT_SIG';
      } else if (prev && !prev.spaced) {
        if (value === '(' && (_ref5 = prev[0], __indexOf.call(CALLABLE, _ref5) >= 0)) {
          if (prev[0] === '?' && this.tokens[this.tokens.length - 2][0] !== '=') {
            prev[0] = 'FUNC_EXIST';
          }
          if (!(prev[0] === '?' && this.tokens[this.tokens.length - 2][0] === '=')) {
            tag = 'CALL_START';
