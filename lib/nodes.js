(function() {
  var Access, Arr, ArrayContract, Assign, Base, Block, CONTRACT_PREFIX, Call, Class, Closure, Code, Comment, ContractOp, ContractValue, Existence, Extends, For, FunctionContract, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, ObjectContract, Op, OptionalContract, Param, Parens, Push, Range, RestContract, Return, SIMPLENUM, Scope, SelfContract, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, WrapContract, YES, c, compact, del, ends, extend, flatten, last, makeObjectProp, merge, multident, starts, unfoldSoak, utility, _ref;
