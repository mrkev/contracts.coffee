(function() {
  ...
  contractsSource = require('./contracts').contractsSource;
  ...
  exports.OptionalContract = OptionalContract = (function() {
    ...
    OptionalContract.prototype.compileNode = function(o) {
      return "Contracts.combinators.opt(" + (this.value.compile(o)) + ")";
    };
  ...
  exports.ContractOp = ContractOp = (function() {
    ...
    ContractOp.prototype.compileNode = function(o) {
      if (this.op === '||') {
        return "Contracts.combinators.or(" + (this.first.compile(o)) + ", " + (this.second.compile(o)) + ")";
      } else if (this.op === '&&') {
        return "Contracts.combinators.and(" + (this.first.compile(o)) + ", " + (this.second.compile(o)) + ")";
      } else {
  ...
  exports.SelfContract = SelfContract = (function() {
    ...
    SelfContract.prototype.compileNode = function(o) {
      return "Contracts.combinators.self";
    };
    return SelfContract;
  })();
  ...
  exports.FunctionContract = FunctionContract = (function() {
    ...
    FunctionContract.prototype.compileNode = function(o) {
      ...
      return "Contracts.combinators.fun(" + params + ", " + range + ", " + (this.options.compile(o)) + ")";
    };
  ...
  exports.RestContract = RestContract = (function() {
    ...
    RestContract.prototype.compileNode = function(o) {
      return "Contracts.combinators.___(" + (this.contract.compile(o)) + ")";
    };
    return RestContract;
  })();
  exports.ObjectContract = ObjectContract = (function() {
    ...
    ObjectContract.prototype.compileNode = function(o) {
      return "Contracts.combinators.object(" + (this.oc.compile(o)) + ", " + (this.options.compile(o)) + ")";
    };
  ...
  exports.ArrayContract = ArrayContract = (function() {
    ...
    ArrayContract.prototype.compileNode = function(o) {
      return "Contracts.combinators.arr(" + (this.arc.compile(o)) + ")";
    };
  ...
  exports.ContractValue = ContractValue = (function() {
    ...
    ContractValue.prototype.compileNode = function(o) {
      ...
      if (o.contracts) {
        return "Contracts.combinators.guard(" + (this.contract.compile(o, LEVEL_PAREN)) + "," + (this.value.compile(o, LEVEL_PAREN)) + ")";
      } else {
