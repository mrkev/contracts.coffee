...
(function() {
  ...
  var dropUnit, leftOps, makeQuantity, makeUnit, rightOps, secret, unaryOps;

  secret = {};

  makeQuantity = function(u, i, n) {
    var h;
  ...
  exports.makeUnit = makeUnit = function(u) {
