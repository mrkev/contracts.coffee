(function() {(function() {
  ...
  var FlapjaxBehavior, Reactive, fj, makeIdHandler, merge, numBinaryOps, numUnaryOps, reactive, secret, _ref;
  ...
  exports.reactive = guard(fun([or(Num, FlapjaxBehavior)], Reactive, {}),reactive);
