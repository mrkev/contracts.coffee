(function() {(function() {
  ...
  var Behavior, EventStream, PQ, Pulse, andE, changes, collectE, constantB, constantE, createNode, createTimerNodeStatic, delayE, delayStaticE, disableTimer, disableTimerNode, doNotPropagate, filterE, genericAttachListener, genericRemoveListener, ifB, ifE, internalE, lastRank, liftB, mapE, mergeE, nextStamp, onceE, oneE, orE, propagatePulse, recE, receiverE, sendBehavior, sendEvent, skipFirstE, snapshotE, stamp, startsWith, switchE, timerB, timerDisablers, timerE, valueNow, zeroE, ___timerID, __getTimerId;
  ...
  exports.Behavior = Behavior = function(event, init, updater) {
    var behave;
  ...
  exports.receiverE = receiverE = function() {
    var evt;
    evt = internalE();
  ...
  exports.startsWith = startsWith = function(e, init) {
  ...
  Behavior.prototype.ifB = function(trueB, falseB) {
    var testB;
    testB = this;
    if (Proxy.dispatchTest(Proxy.dispatchBinary('instanceof', Proxy.dispatchUnary('!', trueB, function() { return !trueB; }), Behavior, function() { return Proxy.dispatchUnary('!', trueB, function() { return !trueB; }) instanceof Behavior;}))) {
      trueB = constantB(trueB);
    }
    if (Proxy.dispatchTest(Proxy.dispatchBinary('instanceof', Proxy.dispatchUnary('!', falseB, function() { return !falseB; }), Behavior, function() { return Proxy.dispatchUnary('!', falseB, function() { return !falseB; }) instanceof Behavior;}))) {
  ...
  ifB = function(test, cons, altr) {
    if (Proxy.dispatchTest(Proxy.dispatchBinary('instanceof', Proxy.dispatchUnary('!', test, function() { return !test; }), Behavior, function() { return Proxy.dispatchUnary('!', test, function() { return !test; }) instanceof Behavior;}))) {
      test = constantB(test);
    }
