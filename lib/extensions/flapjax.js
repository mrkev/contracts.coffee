(function() {(function() {
  ...
  var Behavior, EventStream, PQ, Pulse, andE, changes, collectE, constantE, createNode, createTimerNodeStatic, delayE, delayStaticE, disableTimer, disableTimerNode, doNotPropagate, filterE, genericAttachListener, genericRemoveListener, ifE, internalE, lastRank, liftB, mapE, mergeE, nextStamp, onceE, oneE, orE, propagatePulse, recE, receiverE, sendBehavior, sendEvent, skipFirstE, snapshotE, stamp, startsWith, switchE, timerB, timerDisablers, timerE, valueNow, zeroE, ___timerID, __getTimerId;
